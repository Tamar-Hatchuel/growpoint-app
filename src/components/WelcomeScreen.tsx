...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  return <div className="min-h-screen bg-gradient-to-br from-growpoint-soft via-white to-growpoint-primary/20 relative overflow-hidden">
      {/* Floating Background Elements */}
      <div className="absolute top-20 left-10 w-32 h-32 bg-growpoint-primary/10 rounded-full blur-3xl animate-float"></div>
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-growpoint-accent/10 rounded-full blur-3xl animate-float" style={{
      animationDelay: '1s'
    }}></div>
      <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-growpoint-dark/5 rounded-full blur-2xl animate-float" style={{
      animationDelay: '2s'
    }}></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="flex items-center justify-center mb-6">
            <img src="/lovable-uploads/d7cd3b1a-3e3c-49c7-8986-3d60c7901948.png" alt="GrowPoint" className="w-20 h-20 object-contain" style={{
        ...
        <Card className="max-w-4xl w-full mb-12 border-growpoint-accent/20 shadow-xl bg-white/80 backdrop-blur-sm animate-scale-in">
          <CardContent className="p-8 md:p-12 text-center">
            <p className="text-lg text-growpoint-dark leading-relaxed md:text-lg">GrowPoint is your team's invisible mirror. Understand real dynamics, improve cohesion, and accelerate team growth - powered by anonymous feedback and AI-driven insights.</p>
          </CardContent>
        </Card>
        ...
        animationDelay: '0.8s'
          ...
          <Button onClick={handleStart} className="bg-growpoint-primary hover:bg-growpoint-accent text-white font-bold text-lg px-12 py-4 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
            Start Your Survey
          </Button>
        </div>

        {/* Subtitle */}
        <p className="text-growpoint-dark/60 text-center mt-6 max-w-md animate-fade-in" style={{
        animationDelay: '1s'
      }}>
